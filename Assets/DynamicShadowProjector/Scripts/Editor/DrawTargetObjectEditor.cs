...
namespace DynamicShadowProjector.Editor {
	...
	public class DrawTargetObjectEditor : EditorBase {
		...
		public override void OnInspectorGUI ()
		{
			...
			SerializedProperty propAutoDetect = serializedObject.FindProperty("m_autoDetectHierarchyChanges");
			EditorGUILayout.PropertyField(propAutoDetect);
			if (prop.boolValue && propAutoDetect.boolValue)
			{
				GUI.enabled = false;
				EditorGUILayout.TextArea("This component will check the hierarchy under the Target object EVERY FRAME! If possible, instead of enabling this property, please call 'SetCommandBufferDirty' function of this component after you add/delete/activate/deactivate child objects from script.", richTextStyle);
			}
